...
const Search = () => {
  return (
    <div className="relative h-full z-10   ">
      <div className="rounded-lg absolute p-10 shadow-xl  bg-gray-100 left-[25%] top-[25%]">
        <form className="w-[600px]">
          ...
          <div className="relative flex item-center">
            ...
            <input
              type="search"
              id="default-search"
              className=" outline-none w-[600px] py-4 ps-10 pr-[100px] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50  "
              placeholder="Search..."
              required
            />
            <button
